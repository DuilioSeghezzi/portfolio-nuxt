<script setup lang="ts">
    ...
    function displayjava(){
        esperienza.value="Paragrafo di spiegazione sul perché è bello Java";
    }
    function displaynuxt(){
        esperienza.value="Paragrafo di spiegazione sul perché è bello NUXT";
    }
</script>
